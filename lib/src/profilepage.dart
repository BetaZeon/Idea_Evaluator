  ...
  Widget build(BuildContext context) {
    ...
    var column = Column(children: <Widget>[
                UserAccountsDrawerHeader(
                  ...
                  accountEmail: Text('ashwanitripathi144@gmail.com',style: TextStyle(color: Colors.black),),
                  accountName: Text('Ashwani Tripathi',style: TextStyle(color: Colors.black),),
                ),
          ...
          body: new Center(
            child: new Column(
              children: <Widget>[
                ...
                new Text('Ashwani Tripathi', style: new TextStyle(fontWeight: FontWeight.bold, fontSize: _width/15, color: Colors.white),),
